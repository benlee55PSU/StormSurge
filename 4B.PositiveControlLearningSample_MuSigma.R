...
#Non-Stationary Mu and Sigma GEV Data
#
##############################################################################################
...
mu0<-2.41 ;sigm0<-0.48 ;xi0<-0.54 ;amu<-0.13;asigma<-0.49; axi<-0 # Initialize Grinsted Parameters
...
save(temps_26,temps_45,temps_60,temps_85,trueparmat,
     file="Box Sync/FinalPaper/DataRepository/PositiveControlSample_Learning1923_MuSigma.Rdata") #Save
rm(list=ls())
...
load("Box Sync/FinalPaper/DataRepository/PositiveControlSample_Learning1923_MuSigma.Rdata")
...
save(tempdat,file="Box Sync/FinalPaper/DataRepository/PositiveControlSample_Learning45_1923_MuSigma.Rdata")
...
# Save File
save(finaltempdat45,file="Box Sync/FinalPaper/DataRepository/FinalPositiveControlSample45_1923_MuSigma.Rdata")


for(i in 9:18){
  print(c(min(finaltempdat45[[i]][[2]]),max(finaltempdat45[[i]][[2]])))
}
