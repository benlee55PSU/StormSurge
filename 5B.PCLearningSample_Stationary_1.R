...
for(k in 1:length(ensembleMember)){
 ...
 #   set.seed(i*9)
  ...
  save(temps_45,trueparmat,
       file=paste("Box Sync/FinalPaper/DataRepository/PositiveControlSample_Learning1923_SingleRealization_Stat_",k,".Rdata",sep="")) #Save
  ...
  save(tempdat,file=paste("Box Sync/FinalPaper/DataRepository/PositiveControlSample45_1923_SingleRealization_Stat_",k,".Rdata",sep=""))
  ...
  # Save File
  save(finaltempdat45,file=paste("Box Sync/FinalPaper/DataRepository/FinalPositiveControlSample45_1923_SingleRealization_Stat_",k,".Rdata",sep=""))
}
