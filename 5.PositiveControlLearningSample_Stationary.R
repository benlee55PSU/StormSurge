...
# Stationary GEV Parameters from Grinsted et al. (2013)
mu0<-2.41 ;sigm0<-0.48 ;xi0<-0.54 ;amu<-0;asigma<-0; axi<-0 # Initialize Grinsted Parameters
...
save(temps_26,temps_45,temps_60,temps_85,trueparmat,
     file="Box Sync/FinalPaper/DataRepository/PositiveControlSample_Learning1923_Stat.Rdata") #Save
rm(list=ls())
...
load("Box Sync/FinalPaper/DataRepository/PositiveControlSample_Learning1923_Stat.Rdata")
...
save(tempdat,file="Box Sync/FinalPaper/DataRepository/PositiveControlSample45_1923_Stat.Rdata")

load("Box Sync/FinalPaper/DataRepository/PositiveControlSample_Learning1923_Stat.Rdata")

# Process the list for the learning study
length(tempdat$tempset)/52
end<-c(seq(10,170,by=10)*52,length(tempdat$tempset))
...
# Save File
save(finaltempdat45,file="Box Sync/FinalPaper/DataRepository/FinalPositiveControlSample45_1923_Stat.Rdata")
